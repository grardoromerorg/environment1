...
class Functions(Inicializar):
    ...
    def abrir_navegador(self, URL=Inicializar.URL, navegador=Inicializar.NAVEGADOR):
        print("\nDirectorio Base: " + Inicializar.basedir)
        self.ventanas = {}
        print("----------------")
        print(navegador)
        print("---------------")
        ...
        if navegador == ("CHROME"):
            ...
            self.driver = webdriver.Chrome(chrome_options=options, executable_path=Inicializar.basedir + u"/drivers/chromedriver")
        ...
        if navegador == ("FIREFOX"):
            self.driver = webdriver.Firefox(executable_path=Inicializar.basedir + u"/drivers/geckodriver")
            self.driver.implicitly_wait(10)
    ...
    ### Entity = valor que quiero leer dentro del json (ej, titulo, nombre,etc)
    ...
    # OBTENER TEXTO DE UN ELEMENTO O LABEL
    ...
    def create_path(self):
        ...
        # testcase: extrae el nombre de la clase
